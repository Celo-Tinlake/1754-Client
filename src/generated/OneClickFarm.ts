...
export interface OneClickFarmInterface extends utils.Interface {
  functions: {
    "depositIntoFarmSwappa(address,uint256[],address[][],address[][],bytes[][],uint256,address,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "depositIntoFarmSwappa",
    values: [
...
export interface OneClickFarm extends BaseContract {
  ...
  functions: {
    depositIntoFarmSwappa(
      ...
      farmWrapper: PromiseOrValue<string>,
      farmAddress: PromiseOrValue<string>,
